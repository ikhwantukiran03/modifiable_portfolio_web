<html lang = "en">
    ...
    <body class ="bg-white shadow-md">
        <!--Navigation-->
        <nav class= "bg-white shadow-md">
            <div  class="container mx-auto px-4 py-3">
                <div class ="flex justify-between item-center">
                    <a href="{{route('home')}}" class="text-2x1 font-bold text-indigo-600">Portfolio</a>

                    <div class ="hidden md:flex space-x-6">
                        <a href="{{route('home')}}" class="text-gray-700 hover:text-indigo-600">Home<</a>
                        <a href="{{route('about.index')}}" class="text-gray-700 hover:text-indigo-600">About</a>
                        <a href="{{route('projects.index')}}" class="text-gray-700 hover:text-indigo-600">Projects</a>
                        <a href="{{route('contact.index')}}" class="text-gray-700 hover:text-indigo-600">Contact</a>

                        @auth
                            <a href="{{route(admin.dashboard)}}" class="text-gray-700 hover:text-indigo-600">Dashboard</a>
                    ...
                    <!--Mobile Menu -->
                    <div id="mobile-menu" class="md:hidden mt-4 pb-4">
                        ...
                        <a href="{{route('projects.index')}}" class="block py-2 text-gray-700 hover:text-indigo-600 transition">Portfolio</a>
                    ...
                    @auth 
                        <a href="{{route('admin.dashboard')}}" classs="block py-2 text-gray-700 hover: text-indigo-600 transition">Dashboard</a>
